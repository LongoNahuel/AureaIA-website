...
// ASCII videos — 30FPS simulation of video content
const asciiVideoFrames = {
  robo: [
    `┌──────────────────────────────┐
│░░░░░░░░░░░░░░░░░░░░░░░░░░░░│
│░  ╱╲  ┌────────────────┐  ░│
...
document.querySelectorAll('.portfolio-card').forEach((card, idx) => {
  ...
  function updateFrame() {
    const frames = asciiVideoFrames[videoType];
    const code = ascii.querySelector('code');
    if (code) {
      code.textContent = frames[frameIndex];
  ...
  function startAnimation() {
    ...
    frameIndex = 0;
    updateFrame();
    animationId = setInterval(updateFrame, 33.33); // 30 FPS
  }
  ...
  asciiVideoAnimations[idx] = { start: startAnimation, stop: stopAnimation };
});
